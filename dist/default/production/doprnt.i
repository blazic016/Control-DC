...
# 2 "<built-in>" 2
# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\include\\c90\\ctype.h" 1 3
...
# 2 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 3 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 4 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 7 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\include\\c90\\float.h" 1 3
# 8 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 463 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
int
...
sprintf(char * sp, const char * f, ...)
{
 ...
 char c;
# 516 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
 signed char prec;



 unsigned char flag;
# 535 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
 union {
  unsigned long vd;
  double integ;
 } tmpval;
 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 654 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  switch(c = *f++) {

  case 0:
   goto alldone;
# 716 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  case 'd':
  case 'i':
   break;
# 821 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  default:
   ...
   ((*sp++ = (c)));
   continue;
# 841 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  }
# 1272 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  {
...
# 1324 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
   for(c = 1 ; c != sizeof dpowers/sizeof dpowers[0] ; c++)
    if(val < dpowers[c])
     break;
# 1441 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  {
# 1457 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
   if(flag & 0x03)
    ((*sp++ = ('-')));
# 1488 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  }
  ...
  while(prec--) {
   ...
   {
# 1508 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
    c = (val / dpowers[prec]) % 10 + '0';
# 1542 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
   }
   ((*sp++ = (c)));
  }
